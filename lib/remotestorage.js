var config = require('../data/config').remotestorage,
  remoteStorage = require('../remotestorage-server')('./data');

function oauth(req, res) {
  remoteStorage.auth(url.parse(req).query, function(err, redirectUrl, preExisting) {
    res.writeHead(200, {
